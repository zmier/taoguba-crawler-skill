...
def main() -> None:
    parser = argparse.ArgumentParser(description="运行淘股吧受控 full trial")
    parser.add_argument("--db", default=str(PROJECT_ROOT / "data" / "tgb-full-trial.sqlite"))
    ...
    parser.add_argument("--max-articles-per-page", type=int, default=20)
    parser.add_argument("--max-comment-pages", type=int, default=5)
